...
def eval_replies(gold: list[dict], retriever: Retriever, client, tiers: list[str]) -> dict:
    print("\n" + "=" * 78 + "\n3. REPLIES\n" + "=" * 78)
...
def write_results(res: dict) -> None:
    ...
    L += ["", f"_Generated by evaluate.py in {res['seconds']:.0f}s; LLM: {res.get('llm', 'none')}_"]
